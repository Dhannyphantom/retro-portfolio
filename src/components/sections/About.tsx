      ...
      <div>
        {SERVICES.map((s, i) => (
          <div key={s.title} className={`flex gap-[18px] py-[22px] ${i !== 0 ? "border-t border-white/[0.07]" : ""}`}>
            ...
            <div className="icon-hover w-10 h-10 rounded flex items-center justify-center flex-shrink-0 text-violet" style={{ border: "1px solid rgba(180,92,255,0.18)", background: "rgba(139,47,224,0.05)" }}>
              <s.icon size={17} />
            </div>
            <div>
      ...
      <div>
        <Reveal from="right">
          <div className="flex items-center gap-2.5 mb-[18px]">
            ...
            <span className="font-mono text-xs tracking-widest" style={{ color: "rgba(180,92,255,0.62)" }}>INTRODUCE</span>
          </div>
