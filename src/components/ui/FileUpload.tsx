    ...
    <div>
      ...
      {fileName ? (
        <div className="flex items-center justify-between rounded px-3.5 py-2.5 text-[13.5px] bg-white/[0.04] border border-white/[0.12]">
          <span className="inline-flex items-center gap-2 truncate"><FileText size={15} className="text-neon flex-shrink-0" /> {fileName}</span>
        ...
        <button
          ...
          disabled={uploading}
          className="w-full flex items-center justify-center gap-2 rounded px-3.5 py-3 text-[13.5px] text-mute border border-dashed border-white/[0.18] hover:border-neon/40 transition-colors"
        >
