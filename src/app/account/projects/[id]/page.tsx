  ...
  return (
    <div className="max-w-[1000px] mx-auto px-7 pt-14 pb-24">
      ...
      <div className="flex justify-between items-start flex-wrap gap-4 mb-8">
        <div>
          <span className="font-mono text-xs tracking-widest" style={{ color: "rgba(0,229,255,0.42)" }}>{b.referenceId}</span>
          <h1 className="font-display text-[clamp(14px,2vw,18px)] tracking-tight mt-3 leading-relaxed">{b.projectType || "Project"}</h1>
        </div>
        <span className="text-[12px] font-mono px-3 py-1.5 rounded" style={{ color: "#00E5FF", background: "rgba(57,255,20,0.08)", border: "1px solid rgba(0,229,255,0.24)" }}>{b.status}</span>
      </div>
      ...
      <div className="mb-10">
        <h2 className="font-display text-[13px] mb-4 leading-relaxed">Timeline & milestones</h2>
