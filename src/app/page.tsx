...
export default async function HomePage() {
  ...
  return (
    <RetroHome
      ...
      philosophyLines={philosophyLines.length ? philosophyLines.map((p: any) => p.text) : FALLBACK_PHILOSOPHY}
...
const FALLBACK_PROJECTS = [
  { title: "Monthly Quiz Competition", slug: "monthly-quiz-competition", category: "Mobile", description: "A live monthly quiz competition inside a mobile app — paginated leaderboards, celebratory winner cards, and automatic wallet crediting.", technologies: ["React Native", "Node.js", "MongoDB"], thumbnail: "https://images.unsplash.com/photo-1581287053822-fd7bf4f4bfec?auto=format&fit=crop&w=800&q=80", featured: true },
...
const FALLBACK_SERVICES = [
  ...
  { title: "MVP Development", description: "Ship a working product fast.", icon: "Rocket" },
...
const FALLBACK_RATECARDS = [
  { name: "Hourly", billingType: "hourly", price: "$35", unit: "/ hour", description: "For focused, well-scoped work.", features: ["Flexible engagement", "Weekly time logs"] },
  { name: "Project-Based", billingType: "project", price: "$1,200", unit: "starting at", description: "For a defined product or feature set.", features: ["Fixed scope & timeline", "30 days post-launch support"], recommended: true },
  { name: "Monthly Retainer", billingType: "retainer", price: "$800", unit: "/ month", description: "For ongoing product partnership.", features: ["Priority response time", "Cancel anytime"] },
];

const FALLBACK_FAQS = [
  { question: "What technologies do you use?", answer: "React Native, Next.js, Node.js and MongoDB, with TypeScript throughout." },
...
const FALLBACK_PHILOSOPHY = ["Build things that matter.", "Keep it simple.", "Engineer for scale.", "Performance is a feature.", "Great software feels invisible."];
