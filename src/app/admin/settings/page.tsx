...
export default function AdminSettings() {
  ...
  return (
    <div className="max-w-[560px]">
      ...
      <p className="text-mute text-sm mb-7">Global site content — name, bio, socials, CV.</p>
      ...
      <div className="flex flex-col gap-4">
        ...
        <button onClick={save} className="mt-2 text-sm px-4 py-3 rounded bg-gradient-to-r from-purple to-purple-2 w-full">Save settings</button>
      </div>
    </div>
  );
}
