  ...
  return (
    <div style={{ maxWidth: 560 }}>
      ...
      <p style={{ fontFamily: "var(--font-retro-body)", fontSize: 12, color: "var(--text-dim)", marginBottom: 24 }}>
        Global site content — name, bio, socials, CV.
      </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <Field label="cv file url"><RetroInput value={form.cvUrl || ""} onChange={(e) => set("cvUrl", e.target.value)} placeholder="Upload your CV somewhere and paste the link" /></Field>
