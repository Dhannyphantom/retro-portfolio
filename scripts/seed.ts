 ...
 *
 * NOTE: this file is run standalone via `tsx`, not through Next.js — so it
 * does NOT get the automatic .env.local loading that `next dev`/`next
 * build` provide. We load it ourselves via dotenv, and do so before any
 * other import so MONGODB_URI is populated by the time connectDB() (called
 * lazily inside seed(), below) reads it.
 */
import dotenv from "dotenv";
import path from "path";

dotenv.config({ path: path.resolve(process.cwd(), ".env.local") });
// Fallback for anyone using a plain .env instead — dotenv won't override
// keys already set above, so this is safe to call unconditionally.
dotenv.config();
...
async function seed() {
  ...
  await Project.insertMany([
    {
      ...
      longDescription:
        "Paginated leaderboards, celebratory winner cards, and automatic wallet crediting for prize payouts, built with React Native and a Node.js/MongoDB backend.",
      technologies: ["React Native", "Node.js", "MongoDB"],
      features: [
        "Live leaderboard",
        "Automatic prize wallet crediting",
    ...
    },
    {
      ...
      category: "Mobile",
      description:
        "A podcast player rebuilt around full-bleed artwork and gesture-driven playback.",
    ...
    },
    {
      ...
      category: "Mobile",
      description:
        "A scripture reading app with a three-step verse-grid navigator.",
    ...
    },
    {
      ...
      category: "Backend",
      description:
        "A batch pipeline converting DOCX question banks into schema-validated JSON.",
  ...
  await Service.insertMany([
    ...
    },
    {
      ...
      description:
        "Next.js sites with motion and structure that earn attention.",
      icon: "Globe",
      order: 2,
    },
    {
  ...
  await Testimonial.insertMany([
    {
      ...
      quote:
        "Daniel took a messy content pipeline and turned it into something our whole team could rely on.",
      rating: 5,
      featured: true,
    },
    {
      ...
      quote:
        "The podcast app redesign felt like a completely different product.",
      rating: 5,
    },
  ]);
  ...
  await TechStack.insertMany([
    {
      name: "React",
      iconUrl: "https://cdn.simpleicons.org/react/39FF14",
      showInHero: true,
      showInMarquee: true,
      order: 1,
    },
    {
      name: "Next.js",
      iconUrl: "https://cdn.simpleicons.org/nextdotjs/39FF14",
      showInHero: true,
      showInMarquee: true,
      order: 2,
    },
    {
      name: "Node.js",
      iconUrl: "https://cdn.simpleicons.org/nodedotjs/39FF14",
      showInHero: true,
      showInMarquee: true,
      order: 3,
    },
    {
      name: "TypeScript",
      iconUrl: "https://cdn.simpleicons.org/typescript/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 4,
    },
    {
      name: "MongoDB",
      iconUrl: "https://cdn.simpleicons.org/mongodb/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 5,
    },
    {
      name: "Tailwind CSS",
      iconUrl: "https://cdn.simpleicons.org/tailwindcss/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 6,
    },
    {
      name: "Redux Toolkit",
      iconUrl: "https://cdn.simpleicons.org/redux/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 7,
    },
    {
      name: "Express",
      iconUrl: "https://cdn.simpleicons.org/express/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 8,
    },
    {
      name: "GSAP",
      iconUrl: "https://cdn.simpleicons.org/greensock/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 9,
    },
    ...
    {
      name: "Docker",
      iconUrl: "https://cdn.simpleicons.org/docker/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 11,
    },
    {
      name: "Git",
      iconUrl: "https://cdn.simpleicons.org/git/39FF14",
      showInHero: false,
      showInMarquee: true,
      order: 12,
    },
...
async function seedNewCollections() {
  ...
  await WorkflowStep.insertMany([
    {
      icon: "Search",
      title: "Discover",
      description: "Understand the problem before touching code.",
      order: 1,
    },
    {
      icon: "PenTool",
      title: "Plan",
      description: "Map scope, architecture and milestones.",
      order: 2,
    },
    {
      icon: "Code2",
      title: "Design",
      description: "Structure the data, screens and flows.",
      order: 3,
    },
    {
      icon: "Hammer",
      title: "Build",
      description: "Ship in small, reviewable increments.",
      order: 4,
    },
    {
      icon: "TestTube2",
      title: "Test",
      description: "Catch issues before your users do.",
      order: 5,
    },
    {
      icon: "Rocket",
      title: "Launch",
      description: "Ship it — deploy, monitor, stabilize.",
      order: 6,
    },
    {
      icon: "TrendingUp",
      title: "Scale",
      description: "Grow the system as real usage arrives.",
      order: 7,
    },
  ]);
  ...
  await Photo.insertMany([
    ...
    },
    {
      ...
      caption: "Sketching architecture",
      order: 3,
    },
  ]);
  ...
  await ProjectVideo.insertMany([
    ...
    {
      title: "Why I build for education",
      duration: "0:52",
      thumb:
